...
function wrongAnswerOperation(correctAnswer){
    ...
    //whether to add or substract a random number for wrong answer
    // 1 would add and 2 would be used to substract the base number from the correct answer
...
function answerCheck(correctAnswer){
    ...
    $(".answer-check-btn").click(function(){
        ...
        console.log("Answer Checked Clicked and Chequed");
